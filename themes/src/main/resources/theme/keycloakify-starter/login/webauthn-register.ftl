<!DOCTYPE html><html lang="en"><head><script>
    window.kcContext=  
<#assign pageId="webauthn-register.ftl">
(()=>{
    ...
    out["messagesPerField"]= {
        <#assign fieldNames = [ "totp", "userLabel", "password", "password-confirm", "username", "email", "firstName", "lastName", "global", "my_custom_param" ]>
    ...
    out["keycloakifyVersion"] = "9.1.7";
    out["themeVersion"] = "5.1.3";
    out["themeType"] = "login";
...
<style>
:root {
    --urlcfb808fdc1da114: url(${url.resourcesPath}/build/static/media/background.7cd80027de24cbc2280b.svg);
}
</style>
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="icon" type="image/png" sizes="32x32" href="${url.resourcesPath}/build/favicon-32x32.png"><title>Keycloakify starter</title><link rel="preload" href="${url.resourcesPath}/build/fonts/WorkSans/worksans-bold-webfont.woff2" as="font" crossorigin="anonymous"><link rel="preload" href="${url.resourcesPath}/build/fonts/WorkSans/worksans-medium-webfont.woff2" as="font" crossorigin="anonymous"><link rel="preload" href="${url.resourcesPath}/build/fonts/WorkSans/worksans-regular-webfont.woff2" as="font" crossorigin="anonymous"><link rel="preload" href="${url.resourcesPath}/build/fonts/WorkSans/worksans-semibold-webfont.woff2" as="font" crossorigin="anonymous"><style>@font-face{font-family:'Work Sans';font-style:normal;font-weight:400;font-display:swap;src:url(${url.resourcesPath}/build/fonts/WorkSans/worksans-regular-webfont.woff2) format("woff2")}@font-face{font-family:'Work Sans';font-style:normal;font-weight:500;font-display:swap;src:url(${url.resourcesPath}/build/fonts/WorkSans/worksans-medium-webfont.woff2) format("woff2")}@font-face{font-family:'Work Sans';font-style:normal;font-weight:600;font-display:swap;src:url(${url.resourcesPath}/build/fonts/WorkSans/worksans-semibold-webfont.woff2) format("woff2")}@font-face{font-family:'Work Sans';font-style:normal;font-weight:700;font-display:swap;src:url(${url.resourcesPath}/build/fonts/WorkSans/worksans-bold-webfont.woff2) format("woff2")}</style><script defer="defer" src="${url.resourcesPath}/build/static/js/main.0250ec62.js"></script><link href="${url.resourcesPath}/build/static/css/main.d6540e78.css" rel="stylesheet"></head><body><noscript>You need to enable JavaScript to run this app.</noscript><div id="root"></div></body></html>